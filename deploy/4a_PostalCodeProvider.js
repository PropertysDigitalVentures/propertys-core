...
module.exports = async ({
  ...
  // Config
  console.log(`Deploying PostalCodeProvider... from ${deployer}`);
  ...
  let pcp = await deploy("PostalCodeProvider", {
    from: deployer,
    args: [vrfCoordinator, linkToken, keyhash, fee],
  });

  gasLogger.addDeployment(pcp);
};

module.exports.tags = ["PostalCodeProvider"];
