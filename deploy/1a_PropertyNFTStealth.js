...
module.exports = async ({
  ...
  if (chainId === "31337") {
    ...
    privateSaleStart = Math.round(Date.now() / 1000) + 180;
    publicSaleStart = Math.round(Date.now() / 1000) + 360 + 180;
    linkToken = "0x01BE23585060835E02B77ef475b0Cc51aA1e0709";
    vrfCoordinator = "0xb3dCcb4Cf7a26f6cf6B120Cf5A73875B7BBc655B";
    keyhash =
      "0x2ed0feb3e7fd2022120aa84fab1945545a9f2ffc9076fd6156fa96eaff4c1311";
  ...
  let propertyNFT = await deploy("BobbyFischer", {
    from: deployer,
    proxy: {
      owner: deployer,
      ...
      execute: {
        init: {
          methodName: "__BobbyFischer_init",
          args: [
...
module.exports.tags = ["PropertyNFTStealth"];
