...
contract ERC1155SnapshotUpgradeable is Initializable, ERC1155Upgradeable {
    function __ERC1155SnapshotUpgradeable_init() internal initializer {
        __ERC1155_init_unchained("");
        __Context_init_unchained();
        __ERC1155SnapshotUpgradeable_init_unchained();
    }

    function __ERC1155SnapshotUpgradeable_init_unchained()
        internal
        initializer
    {}
    ...
    struct Snapshots {
        uint256[] ids;
        uint256[] values;
        mapping(uint256 => uint256)[] tokenCounts;
    }
    ...
    /**
     * @dev Retrieves the balance of `account`'s 'tokenId' for ERC115 at the time `snapshotId` was created.
     */
    ...
    function _valueAt(
        ...
        if (index == snapshots.ids.length) {
            ...
            return (true, snapshots.tokenCounts[index][tokenId]);
        }
    }

    function _updateAccountSnapshot(address account, uint256[] memory ids)
        private
    {
    ...
    function _updateSnapshot(
        ...
        if (_lastSnapshotId(snapshots.ids) < currentId) {
            ...
            snapshots.tokenCounts[currentId][tokenId] = currentValue;
        }
    }
